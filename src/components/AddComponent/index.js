...
export default function AddPage() {
  ...
  const [customerName, setCustomerName] = useState(
    actionFlag === 0 ? "" : reservation.customerName
  );
  ...
  const [reservationState, setReservationState] = useState(
    actionFlag === 0 ? "upcoming" : reservation.reservationState
  );
  ...
  const addReservation = () => {
    ...
    let newReservation = {
      ...
      reservationState:
        reservationDateTime < moment().format("YYYY-MM-DDThh:mm") &&
      ...
      <Paper className={classes.paperClass}>
        ...
        <Grid container direction='column'>
          ...
          <TextField
            ...
            inputProps={{
              // min: "YYYY-MM-DDT00:00", 16 characters
