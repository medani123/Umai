      ...
      switch (stateFlag) {
        case 0:
          if (state.reservations.filterDate === null)
            ...
            moment(state.reservations.filterDate).format("yyyy-MM-DD") ===
            moment(wholeReservations[i].reservationDateTime).format(
              "yyyy-MM-DD"
            )
          )
            tempReservations.push(wholeReservations[i]);
        ...
        case 2:
          if (
            wholeReservations[i].reservationState === "finished" ||
            wholeReservations[i].reservationState === "cancelled"
          ) {
            if (state.reservations.filterDate === null)
              tempReservations.push(wholeReservations[i]);
            else if (
                  ...
                  return (
                    <TableRow hover role='checkbox' tabIndex={-1} key={index}>
                      ...
                      <TableCell align='center'>
                        {moment(row.reservationDateTime).format(
                      ...
                      <TableCell
                        align='center'
                        style={{
                          color: determineStateColor(row.reservationState),
                        }}
                      >
